...
namespace Kodify.Repository.Services
{
    public class ProjectAnalyzer
    {
        ...
        public Kodify.Repository.Models.ProjectInfo Analyze()
        {
            var rootPath = DetectProjectRoot();
            return Analyze(rootPath);
        }

        public Kodify.Repository.Models.ProjectInfo Analyze(string path)
        {
            var projectInfo = new Kodify.Repository.Models.ProjectInfo
            {
                ProjectPath = path,
                HasWebApi = false,
